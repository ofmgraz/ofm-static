                    ...
                    <div class="container">
                        <div class="container-fluid">
                            <table id="tocTable">
                                <thead>
                                    <tr>
                                        <th scope="col" width="10%" tabulator-headerFilter="input"
                                            tabulator-formatter="html">Titel</th>
                                        <th scope="col" width="10%" tabulator-headerFilter="input"
                                            tabulator-formatter="html">Dateiname</th>
                                        <th scope="col" width="0%" tabulator-headerFilter="input"
                                            tabulator-visible="false">notBefore</th>
                                        ...
                                        <th scope="col" width="10%" tabulator-headerFilter="input"
                                            >Book Type</th>
                                        <th scope="col" width="10%" tabulator-formatter="html"
                                            tabulator-headerFilter="input">Provenienz</th>
                                        <th scope="col" width="0%" tabulator-formatter="html"
                                        ...
                                        <th scope="col" width="0%" tabulator-headerFilter="input"
                                            >Beschreibung</th>
                                        <th scope="col" width="0%" tabulator-headerFilter="sort"
